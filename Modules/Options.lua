		 ...
		 children = {
			...
			},
			{
				...
				children = {
					...
					{
						type = "CheckBox",
						value = TSM.db.global["Show Full Currency"],
						settingInfo = { TSM.db.global, "ShowFullCurrency" },
						label = L["Show Full Currency Name"],
						tooltip = L["Display the full name of currencys (Gold - Silver - Copper)"],
					},
				},
			},
			{
			...
			},
			{
				...
				children = {
					...
					{
						type = "CheckBox",
						value = TSM.db.global["Separate massage"],
						settingInfo = { TSM.db.global, "SeparateMassage" },
						label = L["Separate Massages"],
						tooltip = L["Separate the massages into separate whispers"],
					},
				},
			},
		},
